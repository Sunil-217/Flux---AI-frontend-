  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 h-16 flex-shrink-0">
        ...
        <button
          onClick={onClose}
          className="fx-touch md:hidden w-8 h-8 flex items-center justify-center rounded-lg text-[var(--ink-3)] hover:text-[var(--ink)] hover:bg-[var(--fill)] transition-colors"
      ...
      <div className="px-3 pb-1 space-y-1.5">
        ...
        <button
          ...
          className="fx-touch w-full flex items-center gap-2 px-3.5 py-2 rounded-lg text-[13px] font-medium text-[var(--ink-3)] hover:text-[var(--ink)] hover:bg-[var(--fill)] transition-colors"
        >
      ...
      <div className="border-t border-[var(--line)] p-3 mt-2">
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            title="Settings"
            aria-label="Settings"
            className="fx-touch w-8 h-8 flex items-center justify-center rounded-lg text-[var(--ink-3)] hover:text-[var(--ink)] hover:bg-[var(--fill)] transition-colors flex-shrink-0"
          >
            <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            title="Sign out"
            aria-label="Sign out"
            className="fx-touch w-8 h-8 flex items-center justify-center rounded-lg text-[var(--ink-3)] hover:text-[var(--fx-danger)] hover:bg-[color-mix(in_srgb,var(--fx-danger)_10%,transparent)] transition-colors flex-shrink-0"
          >
            <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
